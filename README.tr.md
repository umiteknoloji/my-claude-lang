...
`MCL 7.0.0 | ` ile başlıyor. Kararı arayüzden tıklıyorsun — artık
...
Her yanıt `🌐 MCL 7.0.0` ile başlıyor — böylece köprünün aktif olduğunu her zaman biliyorsun.
