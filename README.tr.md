...
`MCL 7.9.6 | ` ile başlıyor. Kararı arayüzden tıklıyorsun — artık
...
Her yanıt `🌐 MCL 7.9.6` ile başlıyor — böylece köprünün aktif olduğunu her zaman biliyorsun.
