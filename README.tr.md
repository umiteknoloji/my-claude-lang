...
`MCL 6.5.0 | ` ile başlıyor. Kararı arayüzden tıklıyorsun — artık
...
Her yanıt `🌐 MCL 6.5.0` ile başlıyor — böylece köprünün aktif olduğunu her zaman biliyorsun.
