...
`MCL 8.1.1 | ` ile başlıyor. Kararı arayüzden tıklıyorsun — artık
...
Her yanıt `🌐 MCL 8.1.1` ile başlıyor — böylece köprünün aktif olduğunu her zaman biliyorsun.
