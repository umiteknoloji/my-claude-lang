...
`MCL 8.0.3 | ` ile başlıyor. Kararı arayüzden tıklıyorsun — artık
...
Her yanıt `🌐 MCL 8.0.3` ile başlıyor — böylece köprünün aktif olduğunu her zaman biliyorsun.
