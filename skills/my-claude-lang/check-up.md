...
SKIP the entire MCL pipeline. Do NOT run Aşama 1/4/7/8/10/11/12.
...
Read the `<mcl_phase name="asama10-risk-review">` block inside the STATIC_CONTEXT
heredoc in `hooks/mcl-activate.sh`.

Read `skills/my-claude-lang/asama10-risk-review.md` (resolve path relative to MCL repo root,
or `~/.claude/skills/my-claude-lang/asama10-risk-review.md` if installed).
...
Do NOT proceed to Aşama 8/4.6/5.
