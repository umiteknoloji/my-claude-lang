...
↓ (sıralı)
  ...
  [Claude modeli cevap üretir]
    Model: AskUserQuestion("MCL 13.0.20 | Faz 1 — Niyet özeti onayı: ...")
    │
    ▼
  ...
  Katman B (Faz İzin Listesi) — v13.0.20 always-fire:
     Her fazda sadece o fazın "allowed_tools" listesi izinli. v13.0.20:
  ...
  6. Loop-breaker:
     ...
     (eski mekanizma). v13.0.20 sonrası Katman B'de otomatik açılma YOK —
